...
(function() {
  (function($) {
    ...
    return $.SimpleSearch = {
      ...
      assignSearchForm: function(KeywordFieldId, MessageAreaId, MatchingNumberAreaId, TotalNumberAreaId, ExecuteButtonId, ClearButtonId) {
        ...
        form = {
          ...
          clearMessage: function() {
            this.keyword.focus();
            this.keyword.select();
            return this.setMessage("", this.Target.totalNumber);
          }
        };
      ...
      setup: function(targetItems, KeywordFieldId, MessageAreaId, MatchingNumberAreaId, TotalNumberAreaId, ExecuteButtonId, ClearButtonId) {
        this.Target = this.assignSearchTarget(targetItems);
